            ...
            <div class="mx-auto col-auto p-5" style="width: 50%;" >
                ...
                <form class="mb-3" method="POST" action="../Variables/V_login.php">
                  <div class="mb-4">
                      ...
                      <input type="number" class="form-control bg-teal-x border-0" id="ide" placeholder="Ingresa Nº de identificación" name="identif" required="" />
                  </div>
                  <div class="mb-4">
                    ...
                    <a href="" id="emailHelp" class="form-text text-muted text-decoration-none"><font size="3px">¿Has olvidado tu contraseña?</font></a>
                  </div>
                ...
                <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 mt-auto w-100">
                    <p class="d-inline-block mb-0">¿Todavia no tienes una cuenta?</p> <a href=" CrearUsuario.php" class="text-light font-weight-bold text-decoration-none">Crea una ahora</a>
                </div>
              </div>
        </div>
      </section>
